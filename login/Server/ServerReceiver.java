...
//A class to connect server with reciever 
...
// A class to share the public key  
...
// class that shows error if not able to send that public key
...
//class to encyper the code that is recived form the client 
...
//class that throw the cyper error to the server  
...
//class to recieve the file form client 
...
//function to wait for the cliet to connect 
